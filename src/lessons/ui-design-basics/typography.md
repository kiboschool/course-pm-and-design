...
<aside> 
  💡  Common practice is to use a font size of no less than 16px for body content. This is a guide though and can change depending on the typeface.  
  </aside>
...
Some fonts are free while others are paid. At this stage it’s advisable to use only free fonts. Some great sources of free fonts are; [google fonts](https://fonts.google.com), [adobe fonts](https://fonts.adobe.com) and [font squirrel](https://www.fontsquirrel.com). There are many other font libraries which you can check out through a quick google search. Please avoid the urge to download 10’s of fonts (many designers do this when they start off, myself included 🙈). For now, the fonts in your design tool should be enough, if you need any other fonts during the course we’ll let you know.
...
<details>
 <summary>Other Useful Links on Typography</summary>
 
- [The UX Designers Guide to Typography](https://www.interaction-design.org/literature/article/the-ux-designer-s-guide-to-typography)
- [8 Rules for Perfect Typography in UI](https://blog.prototypr.io/8-rules-for-perfect-typography-in-ui-21b37f6f23ce)
- [10 Principles for Typography Usage in UI Design](https://uxdesign.cc/10-principles-for-typography-usage-in-ui-design-a8f038f43ffd)
- [Mailchimp Typography Patterns](https://ux.mailchimp.com/patterns/typography)
